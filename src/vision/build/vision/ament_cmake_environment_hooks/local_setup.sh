...
: ${AMENT_CURRENT_PREFIX:="/home/parallels/ROS_Workspaces/boat_workspace/src/vision/install/vision"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vision/environment/pythonpath.sh"
